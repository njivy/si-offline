...
**Status (2026-09-23 PT):** v0.5.0 — QC-once sidebar, export QC gate, masters library, change log, tag-aware find, outline status, REF form, honest no B/I. Dist is Vite IIFE (`file://`). No CMS.
